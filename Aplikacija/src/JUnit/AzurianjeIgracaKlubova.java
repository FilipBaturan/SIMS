...
public class AzurianjeIgracaKlubova {
	...
	@Test
	public void dodavanjeIgracaTest() throws ParseException {
		Klub klub = Aplikacija.listaKlubova.get(0);
		int velicina = klub.igraci.size();
		klub.dodajIgraca
		(new Igrac(5, "Ime5", "Prezime5", "1998-05-01", 25, 198));
		...
		(new Igrac(6, "Ime6", "Prezime6", "1998-05-01", 25, 198));
	...
	@Test
	public void brisanjeIgracaIzPrazneListeTest() throws ParseException{
		Klub klub = new Klub("Metalac",3,Aplikacija.listaMesta.get(0), new Trener(666, "Ime trenera", "Prezime trenera", "1998-01-01"));
