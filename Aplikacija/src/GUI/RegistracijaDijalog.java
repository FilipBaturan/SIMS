		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (true/*!pronadjiKorisnika(korisnickoImeTekst, lozinkaTekst*/)
				{
					...
					{
						JOptionPane.showMessageDialog(null, "Vase lozinke se ne poklapaju"
								, "Razlicite lozinke", JOptionPane.INFORMATION_MESSAGE);
					}
					
				}
				else
				{
					JOptionPane.showMessageDialog(null, "Uneti korinisk vec postoji"
							, "Postojeci Korosnik", JOptionPane.INFORMATION_MESSAGE);
				}
			}
		});
